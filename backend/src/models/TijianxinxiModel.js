...
// 体检信息
const TijianxinxiModel = sequelize.define('TijianxinxiModel', {
	id: {
	...
	tijianshijian: {
		...
		allowNull: true,
		set: function(value) {
			this.setDataValue('tijianshijian', value ? moment(value).format('YYYY-MM-DD HH:mm:ss') : null);
		},
		get() {
			const value = this.getDataValue('tijianshijian');
            return value ? moment(value).format('YYYY-MM-DD HH:mm:ss') : '';
        },
		comment: '体检时间',
		field: 'tijianshijian' // 映射数据库字段
	},
	addtime: {
  		type: DataTypes.DATE,
...
export default TijianxinxiModel
