	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('quxiaoyuyue', '新增')">
						Add
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length ? false : true"
						@click="delClick(null)" v-if="btnAuth('quxiaoyuyue', '删除')">
						Delete
					</el-button>
				</div>
			</div>
			<el-table v-loading="listLoading" border :stripe='false' @selection-change="handleSelectionChange"
				ref="table" v-if="btnAuth('quxiaoyuyue', '查看')" :data="list" @row-click="listChange">
				...
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="quxiaoyuanyin" label="Cancellation Reason">
					<template #default="scope">
						{{ scope.row.quxiaoyuanyin }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="quxiaoshijian" label="Cancellation Time">
					<template #default="scope">
