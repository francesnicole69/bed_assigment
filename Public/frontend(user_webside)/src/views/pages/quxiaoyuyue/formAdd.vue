	...
	<div class="edit_view" :style='{}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="24">
					<el-form-item label="physical examination item" prop="tijianxiangmu">
						<el-input class="list_inp"
                                  ...
                                  placeholder="physical examination item"
                                  type="text"
				...
				<el-col :span="24">
					<el-form-item label="physical examination type" prop="tijianleixing">
						<el-input class="list_inp"
                                  ...
                                  placeholder="physical examination type"
                                  type="text"
				...
				<el-col :span="24">
					<el-form-item label="physical examination location" prop="tijiandidian">
						<el-input class="list_inp"
                                  ...
                                  placeholder="physical examination location"
                                  type="text"
				...
				<el-col :span="24">
					<el-form-item label="physical examination cost" prop="tijianfeiyong">
						<el-input class="list_inp"
                                  v-model.number="form.tijianfeiyong"
                                  placeholder="physical examination cost"
                                  type="text"
				...
				<el-col :span="24">
					<el-form-item label="institution account" prop="jigouzhanghao">
						<el-input class="list_inp"
				...
				<el-col :span="24">
					<el-form-item label="cancellation time" prop="quxiaoshijian">
						<el-date-picker
							...
							placeholder="Please select cancellation time" />
					</el-form-item>
				</el-col>
			</el-row>
