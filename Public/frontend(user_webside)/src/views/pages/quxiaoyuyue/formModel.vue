	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">cancellation reason</div>
					<div  class="info_text" >{{detail.quxiaoyuanyin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">cancellation time</div>
					<div  class="info_text" >{{detail.quxiaoshijian}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('quxiaoyuyue','修改')" type="primary" @click="editClick">edit</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('quxiaoyuyue','删除')" type="danger" @click="delClick">delete</el-button>
				</div>
			</div>
		</div>
	</div>
