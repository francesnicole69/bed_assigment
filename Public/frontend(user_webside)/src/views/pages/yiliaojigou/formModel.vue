			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						<span>{{detail.jigoumingcheng}}</span>
					</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('yiliaojigou','审核')&&detail.sfsh!='是'&&detail.sfsh!='否'" type="warning" @click="approvalClick()">审核</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('yiliaojigou','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('yiliaojigou','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
            ...
            title.value = res.data.data.jigoumingcheng
	...
	const approvalClick = (btnType='审核') => {
		...
		if(!btnAuth('yiliaojigou',btnType)){
