	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">examination type</div>
					<div  class="info_text" >{{detail.tijianleixing}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">examination location</div>
					<div  class="info_text" >{{detail.tijiandidian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">examination cost</div>
				...
				<div class="info_item">
					<div class="info_label">institution account</div>
				...
				<div class="info_item">
					<div class="info_label">report time</div>
					<div  class="info_text" >{{detail.baogaoshijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">report details</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.baogaoxiangqing" @click="downClick(detail.baogaoxiangqing)">download</el-button>
						<el-button class="info_undown" v-else disabled>none</el-button>
					</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('tijianbaogao','修改')" type="primary" @click="editClick">edit</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('tijianbaogao','删除')" type="danger" @click="delClick">delete</el-button>
				</div>
			</div>
		</div>
	</div>
