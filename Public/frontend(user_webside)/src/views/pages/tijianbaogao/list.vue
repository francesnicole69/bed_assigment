	...
	<div class="list-page" :style='{}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search" @submit.native.prevent>
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('tijianbaogao','新增')" @click="addClick">add</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="physical examination item" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.tijianxiangmu}}
							</template>
						</el-table-column>
						<el-table-column label="physical examination type" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="institution account" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="report details" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								<el-button v-if="scope.row.baogaoxiangqing" type="text" size="small" @click.stop="download(scope.row.baogaoxiangqing)">download</el-button>
								<el-button v-else disabled type="text" size="small">none</el-button>
							</template>
						</el-table-column>
						<el-table-column label="report time" :resizable='true' align="left" header-align="left">
							<template #default="scope">
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/tijianbaogaoAdd')
	}
	//判断是否从个人中心跳转
