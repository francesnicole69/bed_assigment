			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="体检类型" prop="tijianleixing">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.tijianleixing?true:false"
							v-model="form.tijianleixing" 
							placeholder="请选择体检类型"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in tijianleixingLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
				...
				<el-col :span="24">
					<el-form-item label="体检流程" prop="tijianliucheng">
						<editor class="list_editor" :value="form.tijianliucheng" placeholder="请输入体检流程" :readonly="!isAdd||disabledForm.tijianliucheng?true:false"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.tijianliucheng = res.data.data.tijianliucheng.replace(reg,'../../../cl581915127/file');
