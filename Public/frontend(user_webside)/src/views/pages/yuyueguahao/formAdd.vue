<template>
	<div class="edit_view" :style='{}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="180px" :rules="rules">
			<el-row>
				<el-col :span="24">
					<el-form-item label="reservation number" prop="yuyuebianhao">
						<el-input class="list_inp" v-model="form.yuyuebianhao" placeholder="Please enter the reservation number." readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="24">
				...
				<el-col :span="24">
					<el-form-item label="Institutional Account Number" prop="jigouzhanghao">
						<el-input class="list_inp"
                                  ...
                                  placeholder="Institutional Account Number"
                                  type="text"
				...
				<el-col :span="24">
					<el-form-item label="name of organization" prop="jigoumingcheng">
						<el-input class="list_inp"
				...
				<el-col :span="24">
					<el-form-item label="Past Medical History" prop="jiwangbingshi">
						<editor class="list_editor" :value="form.jiwangbingshi" placeholder="please enter Past Medical History" :readonly="!isAdd||disabledForm.jiwangbingshi?true:false"
							@change="(e)=>editorChange(e,'jiwangbingshi')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.jiwangbingshi = res.data.data.jiwangbingshi.replace(reg,'../../../cl581915127/file');
					...
					context?.$http({
						...
						if(res.data.data.total>=crossOptNum){
							...
							context?.$http({
                                ...
                                //修改跨表数据
                                changeCrossData(objcross)
                                if(context.$toolUtil.isBackAuth('yuyueguahao','支付')){
