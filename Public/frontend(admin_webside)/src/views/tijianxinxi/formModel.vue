				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="physical examination item" prop="tijianxiangmu">
							<el-input class="list_inp" v-model="form.tijianxiangmu" placeholder="physical examination item"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="physical examination type" prop="tijianleixing">
							<el-input class="list_inp" v-model="form.tijianleixing" placeholder="physical examination type"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="physical examination location" prop="tijiandidian">
							<el-input class="list_inp" v-model="form.tijiandidian" placeholder="physical examination location"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="physical examination time" prop="tijianshijian">
							<el-date-picker
								class="list_date"
								...
								placeholder="please select physical examination time" />
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
