			...
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button class="del_btn" type="danger" :disabled="selRows.length ? false : true"
						@click="delClick(null)" v-if="btnAuth('jiankangshuju', '删除')">
						delete
					</el-button>
				</div>
			</div>
			<el-table v-loading="listLoading" border :stripe='false' @selection-change="handleSelectionChange"
				ref="table" v-if="btnAuth('jiankangshuju', '查看')" :data="list" @row-click="listChange">
				...
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="xingbie" label="gender">
					<template #default="scope">
						{{ scope.row.xingbie }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="nianling" label="age">
					<template #default="scope">
						{{ scope.row.nianling }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="tizhong" label="weight (kg)">
					<template #default="scope">
						{{ scope.row.tizhong }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="xueya" label="blood pressure (mmHg)">
					<template #default="scope">
						{{ scope.row.xueya }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="xuetang" label="blood sugar (mg/dL)">
					<template #default="scope">
						{{ scope.row.xuetang }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="xinlv" label="heart rate (bpm)">
					<template #default="scope">
						{{ scope.row.xinlv }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="xuezhi" label="blood lipids (mmol/L)">
					<template #default="scope">
						{{ scope.row.xuezhi }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="shuimianshijian" label="sleep duration (days/hours)">
					<template #default="scope">
						{{ scope.row.shuimianshijian }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="zongdanguchun" label="total cholesterol (mg/dL)">
					<template #default="scope">
						{{ scope.row.zongdanguchun }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="xueyang" label="blood oxygen (bpm)">
					<template #default="scope">
						{{ scope.row.xueyang }}
					</template>
				</el-table-column>
				<el-table-column min-width="140" :resizable='true' :sortable='true' align="left" header-align="left"
					prop="dengjishijian" label="registration time">
					<template #default="scope">
