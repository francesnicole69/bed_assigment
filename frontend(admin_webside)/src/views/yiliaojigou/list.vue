	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.jigouzhanghao" placeholder="Institutional Account Number"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('yiliaojigou','新增')">
						add
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('yiliaojigou','删除')">
						delete
					</el-button>
				</div>
			</div>
			<el-table
				...
				<el-table-column label="Business License" min-width="140" width="120" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="Audit Reply" min-width="140" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						{{scope.row.shhf}}
					</template>
				</el-table-column>
				<el-table-column prop="sfsh" label="Audit Status" min-width="140" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="audit" v-if="btnAuth('yiliaojigou','审核')" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column label="operation" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('yiliaojigou','查看')" @click="infoClick(scope.row.id)">
							details
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('yiliaojigou','修改')">
							edit						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('yiliaojigou','删除')">
							delete						</el-button>
					</template>
				</el-table-column>
			</el-table>
...
<script setup>
	...
	const formName = 'medical establishment'
	...
	const getList = () => {
		...
		params['sort'] = 'id'
		params['order'] = 'desc'
		if(searchQuery.value.jigouzhanghao&&searchQuery.value.jigouzhanghao!=''){
			params['jigouzhanghao'] = '%' + searchQuery.value.jigouzhanghao + '%'
		}
