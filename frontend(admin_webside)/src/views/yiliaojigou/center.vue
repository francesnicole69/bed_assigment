				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="机构账号" prop="jigouzhanghao">
							<el-input class="list_inp" v-model="user.jigouzhanghao" readonly placeholder="机构账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="机构名称" prop="jigoumingcheng">
							<el-input class="list_inp" v-model="user.jigoumingcheng"  placeholder="机构名称" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="营业执照" prop="touxiang">
							<uploads
								...
								@change="yiliaojigoutouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const yiliaojigoutouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.jigouzhanghao)){
			context?.$toolUtil.message(`机构账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
		...
		if((!user.value.jigoumingcheng)){
			context?.$toolUtil.message(`机构名称不能为空`,'error')
			return false
		}
